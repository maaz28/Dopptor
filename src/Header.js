...
export default function Header() {
  ...
  const badgeClickHandler = (id, render_div_id) => {
    $("#" + id).toggleClass("show");
    ...
    <header className="main-header">
      <nav className="navbar navbar-expand-md bg-3">
        ...
        <div className="navbar-options px-3 px-md-4">
          ...
          <ul className="nav">
            <li className="nav-item tasks dropdown" id="task" data-rel="tasks" onClick={() => badgeClickHandler("tasks", "task_show")}>
            ...
            <li className="nav-item notifications dropdown" id="notification" onClick={() => badgeClickHandler("notification", "notifications_show")} data-rel="notifications">
            ...
            <li className="nav-item messages dropdown" data-rel="messages" id="message" onClick={() => badgeClickHandler("message", "messages_show")} >
              <a href="javascript:void(0)" className="nav-link dropdown-toggle pl-4" data-toggle="dropdown">
            ...
            <li className="nav-item account dropdown" id="user_profile" onClick={() => badgeClickHandler("user_profile", "user_profile_show")}>
              <a href="javascript:void(0)" className="nav-link dropdown-toggle pl-4" data-toggle="dropdown">
            ...
            <li className="aside-toggler" data-behavior="absolute" onClick={asideHandler}>
              <a href="javascript:void(0)">
