...
export default function Sidebar() {
  ...
  const tabClickHandler = (id, tab_id) => {
    ...
    <aside className="quick-view">
      <div className="side-wrapper">
        <nav className="nav nav-tabs nav-fill tabs-clean slide">
          <a href="javascript:void(0)" id="aside-profile-tab" className="nav-item nav-link " data-toggle="tab" onClick={() => { tabClickHandler('aside-profile', 'aside-profile-tab') }}>
            <i className="far fa-id-card icon"></i>
          </a>
          <a href="javascript:void(0)" id="aside-todo-tab" className="nav-item nav-link active" data-toggle="tab" onClick={() => { tabClickHandler('aside-todo', "aside-todo-tab") }} data-rel="todos">
            <i className="fas fa-list-ul icon"></i>
          </a>
          <a href="javascript:void(0)" id="aside-users-tab" className="nav-item nav-link" data-toggle="tab" onClick={() => { tabClickHandler('aside-users', "aside-users-tab") }} data-rel="users">
            <i className="fas fa-users icon"></i>
          </a>
          <a href="javascript:void(0)" id="aside-settings-tab" className="nav-item nav-link" data-toggle="tab" onClick={() => { tabClickHandler('aside-settings', "aside-settings-tab") }}>
